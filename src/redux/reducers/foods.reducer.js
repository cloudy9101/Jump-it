import { FETCH_FOODS_SUCCESS, FETCH_FOODS_ERROR, ADD_FOOD_SUCCESS, UPDATE_FOOD_VALUE, UPDATE_FOOD_NAME, DELETE_FOOD_SUCCESS } from '../actiontypes/index';
...
const foods = (state = foodsInitState, action) => {
  switch(action.type) {
    ...
    case DELETE_FOOD_SUCCESS:
      return { isFinished: true, data: state.data.filter((item) => { return item._id != action.data; }) }
      break;
    default:
      return state;
  }
